...
namespace TAG.Payments.OpenPaymentsPlatform
{
    ...
    public class OpenPaymentsPlatformService : IBuyEDalerService, ISellEDalerService
    {
        ...
        {
            { "ELLFSESS", "2c7774bc-5b01-2ea3-4413-e95df8993592@legal.neuron.vaulter.se" },
            { "ESSESESS", "2c777286-5b01-2e72-4413-e95df869a2ca@legal.neuron.vaulter.se" },
            { "HANDSESS", "2c777461-5b01-2e9c-4413-e95df8262263@legal.neuron.vaulter.se" },
            { "NDEASESS", "2c777366-5b01-2e8a-4413-e95df8946858@legal.neuron.vaulter.se" },
            { "SWEDSESS", "2c7773ed-5b01-2e94-4413-e95df8049e80@legal.neuron.vaulter.se" },
            ...
            decimal Amount, string Currency, string SuccessUrl, string FailureUrl, string CancelUrl, ClientUrlEventHandler ClientUrlCallback, object State)
        {
            ...
            try
            {
                ...
                {
                    await DisplayUserMessage(TabId, "Unable to find a Mobile Bank ID authorization method for the operation.");
